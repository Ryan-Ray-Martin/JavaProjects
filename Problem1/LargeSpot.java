...
/**
 * A concrete class of a Large parking spot, which extends the abstract parking spot, and
 * contains all the method therein, including the methods to get a parking spot's size
 * and assign a vehicle to a parking spot.
 */

public class LargeSpot extends AbstractParkingSpot {

  /** A constructor of the Large parking spot, which contains the size of the
   * parking spot.
   * @param size
   */
  LargeSpot(ParkingSlotSize size) {
    super(size);
  }
